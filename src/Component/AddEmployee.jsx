...
export default function AddEmployee() {
  const [employees, setEmployees] = useState([
    ...
    { id: 102, name: "Ramu kaka", age: 25, city: "Dewas", salary: 25000 },
  ...
  const addEmployee = async () => {
    ...
    try {
      var a = 0
      const response = await axios.post("https://employee-management-backend-code.onrender.com/api/add", newEmployee);
